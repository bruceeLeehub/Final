...
public class FuncDef {
    ...
    public static FuncDef analyse(IdentifySymbol identifySymbol) {
        ...
        Errors.checkIfDupDef(true, preSymbol);// name Duplicated -- type b
        ...
        if (judge) {
            ...
            if (isRPARENT || isLBRACE) {
                ...
                if (noReturnError) {
                    ...
                    Errors.add_ErrorOutPut(rowidx + " g");
                }
            } else {
                ...
                if (isRPARENT1) {
                    ...
                    Errors.add_ErrorOutPut(identifySymbol.get_PreSym().getRow_Idx() + " j");
                }
                // insert funcDef into previous stmTable
                if (CompUnit.isNameDuplicateDef) {
                    CompUnit.isNameDuplicateDef = false;
